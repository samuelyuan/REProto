...
RoomCameraHandler_c6_4000: ; 0x4000
    ...
    ld d, a
    call ScalePositionDown_0c6_64e1 ; divides by 8
    ld l, e
    ld h, d
...
jr_0c6_5028:
    ...
    ld a, [FLAG_PLAYER_CUTSCENE_FINDS_BRAD]
    or a
    jr nz, jr_0c6_504d
    ...
    ld [CUTSCENE_NUMBER], a
    ld a, $ff
    ld [FLAG_PLAYER_CUTSCENE_FINDS_BRAD], a
...
jr_0c6_5759:
    ...
    ld a, [FLAG_PLAYER_CUTSCENE_c486]
    or a
    jr nz, jr_0c6_577e
    ...
    ld [CUTSCENE_NUMBER], a
    ld a, $ff
    ld [FLAG_PLAYER_CUTSCENE_c486], a
...
jr_0c6_614f:
    ...
    ld [CUTSCENE_NUMBER], a
    ld a, $ff
    ld [FLAG_PLAYER_CUTSCENE_c485], a
